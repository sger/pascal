...
pascal: pascal.o errors.o source_buffer.o text_in_buffer.o text_out_buffer.o list_buffer.o common.o scanner.o text_scanner.o parser.o token.o
	$(CC) pascal.o errors.o source_buffer.o text_in_buffer.o text_out_buffer.o list_buffer.o common.o scanner.o text_scanner.o parser.o token.o -o pascal
